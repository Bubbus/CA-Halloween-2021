...
_baseLoadout = [["vn_m2carbine","","","",["vn_carbine_30_mag",30],[],""],[],["vn_m1911","","","",["vn_m1911_mag",7],[],""],["CFP_GUER_GreenTan",[["ACE_fieldDressing",4],["ACE_morphine",4],["ACE_tourniquet",4],["ACE_packingBandage",2],["ACE_epinephrine",1],["ACE_splint",2],["ACE_elasticBandage",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_salineIV",1],["vn_m7_grenade_mag",2,1]]],["CUP_V_OI_TKI_Jacket6_06",[["vn_m67_grenade_mag",1,1],["vn_carbine_30_mag",5,30],["vn_m1911_mag",2,7]]],["vn_b_pack_trp_02",[["ACE_EntrenchingTool",1],["vn_m18_white_mag",2,1],["vn_m34_grenade_mag",2,1],["vn_m67_grenade_mag",1,1],["vn_m18_green_mag",2,1],["vn_m18_red_mag",2,1]]],"usm_bdu_8point_odg","UK3CB_BAF_G_Tactical_Grey",["Binocular","","","",[],[],""],["vn_b_item_map","","","ItemCompass","ItemWatch",""]];
...
_baseLoadout = [["vn_m2carbine","","","",["vn_carbine_30_mag",30],[],""],[],["vn_m1911","","","",["vn_m1911_mag",7],[],""],["CFP_GUER_GreenTan",[["ACE_fieldDressing",4],["ACE_morphine",4],["ACE_tourniquet",4],["ACE_packingBandage",2],["ACE_epinephrine",1],["ACE_splint",2],["ACE_elasticBandage",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_salineIV",1],["vn_m7_grenade_mag",2,1]]],["CUP_V_OI_TKI_Jacket6_06",[["vn_carbine_30_mag",5,30],["vn_m1911_mag",2,7],["vn_m67_grenade_mag",1,1]]],["vn_b_pack_trp_02",[["ACE_elasticBandage",20],["ACE_EntrenchingTool",1],["FSGm_ItemMedicBag",1],["ACE_morphine",6],["ACE_salineIV",8],["ACE_salineIV_500",7],["ACE_splint",10],["ACE_tourniquet",6],["ACE_epinephrine",6],["ACE_adenosine",6],["ACE_personalAidKit",1],["ACE_surgicalKit",1],["vn_m18_white_mag",3,1],["vn_carbine_30_mag",2,30]]],"vn_b_boonie_04_07","UK3CB_BAF_G_Tactical_Grey",["Binocular","","","",[],[],""],["vn_b_item_map","","","ItemCompass","ItemWatch",""]];
...
_baseLoadout = [["vn_m14","","vn_b_m14","",["vn_m14_mag",20],[],""],[],["vn_m1911","","","",["vn_m1911_mag",7],[],""],["CFP_GUER_GreenTan",[["ACE_fieldDressing",4],["ACE_morphine",4],["ACE_tourniquet",4],["ACE_packingBandage",2],["ACE_epinephrine",1],["ACE_splint",2],["ACE_elasticBandage",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_salineIV",1],["vn_m7_grenade_mag",2,1]]],["CUP_V_OI_TKI_Jacket6_06",[["vn_m1911_mag",2,7],["vn_m67_grenade_mag",1,1],["vn_m14_mag",5,20]]],["vn_b_pack_trp_02",[["ACE_elasticBandage",20],["ACE_EntrenchingTool",1],["ACE_morphine",6],["ACE_salineIV",4],["ACE_splint",10],["ACE_tourniquet",6],["ACE_epinephrine",6],["ACE_adenosine",6],["vn_m18_white_mag",3,1],["vn_m14_t_mag",2,20]]],"vn_b_boonie_04_07","UK3CB_BAF_G_Tactical_Grey",["Binocular","","","",[],[],""],["vn_b_item_map","","","ItemCompass","ItemWatch",""]];
...
_baseLoadout = [[],[],["vn_m1895","","","",["vn_m1895_mag",7],[],""],["CFP_GUER_TanTee",[["ACE_fieldDressing",4],["ACE_morphine",4],["ACE_tourniquet",4],["ACE_packingBandage",2],["ACE_epinephrine",1],["ACE_splint",2],["ACE_elasticBandage",4],["ACE_Flashlight_XL50",1],["ACE_MapTools",1],["ACE_salineIV",1],["vn_m7_grenade_mag",2,1]]],["CUP_V_OI_TKI_Jacket1_06",[["vn_m1895_mag",3,7]]],["vn_b_pack_trp_02",[["ACE_EntrenchingTool",1],["vn_m1895_mag",15,7],["vn_m18_white_mag",4,1],["vn_m34_grenade_mag",2,1]]],"CUP_H_NAPA_Fedora","vn_b_scarf_01_03",["Binocular","","","",[],[],""],["vn_b_item_map","","","ItemCompass","ItemWatch",""]];

CREATE_LOADOUT(arch,_baseLoadout);
...
ADD_PISTOL_AMMO_TO_CRATE(small,arch,4); // This crate now contains two of the Rifleman's pistol magazines in it.
ADD_RIFLE_AMMO_TO_CRATE(small,rif,15); // This crate now contains two rifle magazines in it, which the Rifleman can use.
ADD_RIFLE_AMMO_TO_CRATE(small,co,15);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.
ADD_RIFLE_AMMO_TO_CRATE(small,miller,4);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.
ADD_RIFLE_AMMO_TO_CRATE(small,ar,6);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.
ADD_RIFLE_AMMO_TO_CRATE(small,smg,10);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.

ADD_ITEMS_TO_CRATE(small,"vn_22mm_m19_wp_mag",6); // The Rifleman has normal bullets loaded into his gun.  To add Tracer rounds into this box, we can use this command.
ADD_ITEMS_TO_CRATE(small,"vn_22mm_m17_frag_mag",6); // The Rifleman has normal bullets loaded into his gun.  To add Tracer rounds into this box, we can use this command.

ADD_ITEMS_TO_CRATE(small,"vn_m67_grenade_mag",6);
...
ADD_ITEMS_TO_CRATE(small,"ACRE_PRC77",2);
...
ADD_RIFLE_TO_CRATE(med,rif,2);    // This crate now contains two of the Rifleman's rifles in it.
ADD_LAUNCHER_TO_CRATE(med,lat,2); // This crate now contains two of the LAT soldier's launchers in it.
ADD_PISTOL_TO_CRATE(med,rif,2);   // Two of the Rifleman's pistols.  If the Rifleman doesn't have a pistol, you can choose it from other units (for example, ftl or co).

ADD_PISTOL_AMMO_TO_CRATE(med,rif,6); // This crate now contains two of the Rifleman's pistol magazines in it.
ADD_PISTOL_AMMO_TO_CRATE(med,arch,4); // This crate now contains two of the Rifleman's pistol magazines in it.
ADD_RIFLE_AMMO_TO_CRATE(med,rif,15); // This crate now contains two rifle magazines in it, which the Rifleman can use.
ADD_RIFLE_AMMO_TO_CRATE(med,co,15);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.
ADD_RIFLE_AMMO_TO_CRATE(med,miller,4);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.
ADD_RIFLE_AMMO_TO_CRATE(med,ar,6);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.
ADD_RIFLE_AMMO_TO_CRATE(med,smg,10);   // These commands copy whatever magazine is loaded into the weapon in ACE Arsenal.

ADD_ITEMS_TO_CRATE(med,"vn_22mm_m19_wp_mag",6); // The Rifleman has normal bullets loaded into his gun.  To add Tracer rounds into this box, we can use this command.
ADD_ITEMS_TO_CRATE(med,"vn_22mm_m17_frag_mag",6); // The Rifleman has normal bullets loaded into his gun.  To add Tracer rounds into this box, we can use this command.

ADD_ITEMS_TO_CRATE(med,"vn_m67_grenade_mag",6);
ADD_ITEMS_TO_CRATE(med,"SmokeShellBlue",2);
ADD_ITEMS_TO_CRATE(med,"SmokeShellRed",2);
ADD_ITEMS_TO_CRATE(med,"SmokeShell",6);

ADD_ITEMS_TO_CRATE(med,"ACE_SpareBarrel",1);  // to go into battle with a machinegun and not get it red-hot is blasphemous.

ADD_BANDAGES_TO_CRATE(med,40); // This will automatically add a mixture of different bandages into the crate.
ADD_SPLINTS_TO_CRATE(med,20);
ADD_MEDS_TO_CRATE(med,30); // This will automatically add a mixture of different auto-injectors into the crate.
ADD_BLOOD_TO_CRATE(med,15); // This will add eight 1000ml bags of blood.

ADD_BACKPACKS_TO_CRATE(med,rif,2);  // We can also add two of the Rifleman's backpacks in here, in case someone loses theirs or needs to carry extra things.

ADD_ITEMS_TO_CRATE(med,"ACRE_PRC77",2);
ADD_ITEMS_TO_CRATE(med,"Binocular",2);
