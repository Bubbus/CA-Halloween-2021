...
//lumina 1
_unu_lum = "#lightpoint" createVehicle _attck_pos;
...
_bule_spark setParticleParams [["\A3\data_f\blesk1", 1, 0, 1], "", "SpaceObject", 1, 0.3, [0, 0, 0], [0, 0, 0.75], 13, 10, 7.9, 0.075, [0.03, 0.01], [[1, 1, 1, 1], [1, 1, 1, 1]], [0.08], 1, 0, "", "", _voice_attk];
...
_bule_space setParticleParams [["\A3\data_f\ParticleEffects\Universal\Refract.p3d", 1, 0, 1], "", "Billboard", 1, 0.5, [0, 0, 0], [0, 0, 0.75], 0, 10, 7.9, 0.075, [1,20], [[1, 1, 1, 1], [1, 1, 1, 1]], [0.08], 1, 0, "", "", _voice_attk];
...
if (((getpos player) distance _attck_pos) < 500) then {playsound _attack_after;};
